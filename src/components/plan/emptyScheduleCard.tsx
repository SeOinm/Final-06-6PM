...
export default function EmptyScheduleCard({ onAddPlace }: EmptyScheduleCardProps) {
  return (
    <div className="w-full py-8 bg-white border rounded-2xl border-travel-gray200">
      <div className="flex flex-col items-center">
        ...
        <ButtonRounded size="md" variant="fill" className="flex items-center gap-1 mx-auto" onClick={onAddPlace}>

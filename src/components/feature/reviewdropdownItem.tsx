...
interface ReviewDropdownItemProps {
  currentSort: "latest" | "oldest";
  onSortChange: (sort: "latest" | "oldest") => void;
}

export default function ReviewDropdownItem({ currentSort, onSortChange }: ReviewDropdownItemProps) {
  ...
  return (
    <div className="relative">
      <div className="cursor-pointer w-24" onClick={() => setIsOpen(!isOpen)}>
      ...
      {isOpen && (
        <>
          <div className="absolute left-0 mt-1 z-10 w-24 bg-white border rounded-md shadow-lg top-full border-travel-gray200">
            <div

  ...
  return (
    <div className="">
      ...
      <div >
        ...
        <LocationInfoCard />
        <Button variant="outline" className="text-14 my-2">북마크 더보기</Button>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-col items-center justify-center mt-3 gap-1">
          ...
          <h3 className="text-18 font-semibold text-gray-700">검색 결과가 없습니다.</h3>
          <p className="text-14 text-travel-text100 ">내가 찾는 장소가 없나요? 직접 등록해보세요.</p>
